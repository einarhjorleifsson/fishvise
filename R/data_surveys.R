...
#' \code{attach(attach('/net/hafkaldi/u2/reikn/Splus5/SMB/.RData')
#' save('STODVAR',file='~/data/smbSTODVAR.rda')}
...
#' \code{attach("/net/hafkaldi/u2/reikn/Splus5/HAUSTRALL/URV/.RData")
...
#' is copied into this library via:
#' \code{attach(attach('/net/hafkaldi/u2/reikn/Splus5/SMB/.RData')
#' save('LWCOEFF',file='~/data/smbLWCOEFF.rda')}
#' @author Hoskuldur Bjornsson
NULL
